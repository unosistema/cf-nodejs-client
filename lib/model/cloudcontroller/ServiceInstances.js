...
class ServiceInstances extends CloudControllerBase {
     ...
     *
     * @param  {String} guid         [Service Instance guid]
     * @return {JSON}              [information about the service instance]
     */
    start (guid) {
        ...
        return this.update(guid, appOptions);
    }
    ...
    update (appGuid, appOptions) {
        ...
        const url = `${this.API_URL}/v2/service_instances/${appGuid}?accepts_incomplete=true`;
        const options = {
            method: "PUT",
            url: url,
            headers: {
